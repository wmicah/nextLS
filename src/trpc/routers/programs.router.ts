...
export const programsRouter = router({
  ...
  list: publicProcedure.query(async () => {
    ...
    // Exclude superseded programs (those that have been replaced by newer versions)
    let whereClause: any = {
      AND: [
        {
          OR: [
        ...
        {
          // Exclude programs that have been superseded by newer versions
    ...
    .input(
      z.object({
        ...
        title: z
          ...
          .optional(),
        description: z.string().optional(),
        updateScope: z.enum(["all", "future"]).optional().default("all"), // New parameter: "all" = update all assignments, "future" = only future assignments
        weeks: z
          .array(
            z.object({
              weekNumber: z.number(),
