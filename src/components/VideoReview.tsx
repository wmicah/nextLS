...
export default function VideoReview({ videoId }: VideoReviewProps) {
	...
	const isSaving = createAnnotationMutation.isLoading
					...
					>
						...
						<div className="space-y-4">
							...
							<button
								...
								className="w-full px-6 py-3 rounded-xl transition-all duration-200 hover:scale-105 disabled:opacity-50"
								...
								>
									...
									<div className="flex gap-2">
										...
										{isCoach && (
											<button
												onClick={() =>
													handleDeleteScreenRecording(recording.id)
												}
