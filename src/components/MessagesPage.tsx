								...
								>
									...
									>
										...
										<input
											...
											className="flex-1 px-4 py-3 rounded-xl text-sm transition-all duration-300 font-medium"
											style={{
												backgroundColor: "#2a2a2a",
												borderColor: "#374151",
												color: "#f9fafb",
										...
										<button
											...
											className="p-3 rounded-xl transition-all duration-300 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
											style={{
												backgroundColor:
													messageText.trim() || selectedFile
														? "#374151"
