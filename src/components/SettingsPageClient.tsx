		...
		if (userSettings) {
			...
			setScheduleData({
				...
				workingDays: userSettings.workingDays
					? typeof userSettings.workingDays === "string"
						? userSettings.workingDays.split(",").map((day) => day.trim())
						: Array.isArray(userSettings.workingDays)
						? (userSettings.workingDays as string[])
