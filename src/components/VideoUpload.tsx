			...
			>
				{!uploadedFile ? (
					<div className="text-center">
						...
						>
							{isUploading ? (
								<div className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl transition-all duration-200">
									<div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white" />
									<span style={{ color: "#ffffff" }}>Uploading...</span>
								</div>
							) : (
								<div
									className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl transition-all duration-200 hover:scale-105 cursor-pointer"
