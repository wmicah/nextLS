...
import { X, CheckCircle, Plus, Search } from "lucide-react";
...
export default function SimpleAssignRoutineModal({
  ...
  const sortedClients: Client[] = [...(clients as Client[])].sort((a, b) =>
  ...
  // Filter clients based on search term (explicit type avoids deep inference)
  const filteredClients: Client[] = sortedClients.filter(
    client =>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                      {filteredRoutines.map(routine => (
                        ...
                        >
                          ...
                          <p
                            className="text-[10px] mb-1.5 line-clamp-2"
                            style={{ color: COLORS.TEXT_SECONDARY }}
                          >
                            {routine.description}
                          </p>
                ...
                >
                  {clientId ? (
                    ...
                    <div className="space-y-2.5">
                      {(() => {
                        const preSelectedClient = sortedClients.find(
                          c => c.id === clientId
                        );
