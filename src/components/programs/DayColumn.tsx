...
function SortableExerciseItem({ exercise, onDelete }: any) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className='group relative rounded-lg border border-gray-600 hover:border-gray-500 bg-gray-800/50 transition-all duration-200 hover:shadow-md'
    >
      <div className='p-6'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center gap-4 flex-1 min-w-0'>
            ...
            <button
              {...attributes}
              {...listeners}
              className='p-3 rounded hover:bg-gray-700/50 text-gray-400 hover:text-gray-300 transition-colors cursor-grab active:cursor-grabbing flex-shrink-0'
          ...
          <div className='flex items-center gap-2 ml-4 flex-shrink-0'>
            <button
              ...
              className='p-3 rounded hover:bg-red-500/20 text-red-400 hover:text-red-300 transition-colors opacity-0 group-hover:opacity-100'
