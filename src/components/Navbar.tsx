        ...
        {isMobileMenuOpen && (
          <div className='md:hidden border-t border-white/10 bg-black/95 backdrop-blur-xl'>
            <div className='py-4 space-y-2'>
              ...
              <LoginLink>
                <span
                  className='block px-4 py-2 text-sm font-medium text-white/90 hover:text-white hover:bg-white/5 rounded-lg transition-colors duration-200 cursor-pointer'
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Sign In
                </span>
              ...
              <RegisterLink>
                <span
                  className='block px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-sky-500 to-blue-600 rounded-lg hover:from-sky-600 hover:to-blue-700 transition-all duration-200 cursor-pointer'
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  Get Started
                </span>
