...
export default function ChatbotWidget() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      // Don't close on mobile when full screen
      if (isMobile) return;
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={
              isMobile ? "fixed inset-0 z-50" : "absolute bottom-20 right-0"
            }
          >
            ...
            <Card
              ref={chatRef}
              className={cn(
                "relative shadow-2xl border-0 bg-white/80 backdrop-blur-xl overflow-hidden",
                isMobile
            ...
            >
              ...
              <div
                className={cn(
                  "absolute inset-0 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-indigo-500/10",
              ...
              <CardContent className="p-0 h-full flex flex-col bg-gradient-to-b from-white/50 to-gray-50/50">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isMobile && (
                        <Button
                          ...
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 rounded-full hover:bg-gray-200/50 transition-colors"
                        >
                ...
                <div
                  className={cn(
                    "border-t border-gray-200/30 bg-white/40 backdrop-blur-sm",
                    isMobile ? "p-4" : "p-6"
                  )}
                >
                  <div className="flex gap-3">
                    <Input
                      ...
                      disabled={isLoading}
                      className={cn(
                        "flex-1 text-black bg-white/80 backdrop-blur-sm border-gray-200/50 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all duration-200",
                        isMobile
                    ...
                    <Button
                      ...
                      size="icon"
                      className={cn(
                        "bg-gradient-to-br from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:hover:scale-100",
                        isMobile
