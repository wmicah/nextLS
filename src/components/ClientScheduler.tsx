    ...
    <div className='space-y-6'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              >
                ...
                {format(addDays(selectedWeek, 6), "MMMM d, yyyy")}
              </p>
            </div>
          </div>
                ...
                <div className='p-3'>
                  {isEditing ? (
                    <div className='space-y-2'>
                      ...
                      <select
                        onChange={(e) =>
                          handleAssignWorkout(index, e.target.value)
                        }
                      ...
                      <select
                        onChange={(e) =>
                          handleAssignVideo(index, e.target.value)
                        }
                        className='w-full p-1 rounded border text-xs'
                        style={{
                          backgroundColor: "#2A3133",
      ...
      {showTemplateModal && selectedDayIndex !== null && (
        <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
          <div
            className='bg-zinc-800 rounded-lg p-6 max-w-md w-full mx-4 border'
            style={{ borderColor: "#606364" }}
          >
            <h3
