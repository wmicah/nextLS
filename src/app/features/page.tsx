...
function OverviewTab() {
  return (
    <div className="text-center">
      ...
      <p className="text-base sm:text-lg text-zinc-400 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
  ...
  return (
    <div>
      ...
      <div className="mb-8 sm:mb-12 md:mb-16">
        <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6 md:mb-8 text-center">
          Everything You Need to Run Your Business
        </h3>
        <p className="text-sm sm:text-base md:text-lg text-zinc-400 mb-6 sm:mb-8 md:mb-12 text-center max-w-2xl mx-auto px-4 sm:px-0">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-2xl bg-white/5 border border-white/10">
